<template>
    <div>
        ...
        <img :src="avatar" v-bind:alt="descption">
        <mudar-image @mudar-img="TrocaImagem" />
    </div>
</template>

<script>
import MudarImage from './MudarImage.vue'
export default {
    name: "Picture",
    components: {
        MudarImage
    ...
    data() {
        return {
            avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwktGunb0a4j8gZGwCIvKQiq9pf1n8bGA0QkfqzYx0jsz12RU9syffpA2SZ6svdnUovOg&usqp=CAU",
            descption: "Avatar",
        }
    },
